...
class CodeParser {
     ...
     */
    parsePython(filePath, content, nodes, edges, fileNodeId) {
        const lines = content.split('\n');
     ...
     */
    parseGo(filePath, content, nodes, edges, fileNodeId) {
        const lines = content.split('\n');
     ...
     */
    parseRust(filePath, content, nodes, edges, fileNodeId) {
        const lines = content.split('\n');
     ...
     */
    parseMarkdown(filePath, content, nodes, edges, fileNodeId) {
        const lines = content.split('\n');
        for (let i = 0; i < lines.length; i++) {
            const line = lines[i];
     ...
     */
    parseCStyleGeneric(filePath, content, nodes, edges, fileNodeId, language) {
        const lines = content.split('\n');
        // Classes / Interfaces
    ...
    parseGenericText(filePath, content, nodes, edges, fileNodeId) {
    ...
    findMatchingBracketEndLine(lines, startLine) {
        let depth = 0;
        let foundOpen = false;
    ...
    findPythonBlockEndLine(lines, startLineIndex, parentIndent) {
