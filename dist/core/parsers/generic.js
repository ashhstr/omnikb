...
exports.CStyleGenericParser = exports.MarkdownParser = void 0;
...
class CStyleGenericParser {
    ...
    parse(ctx) {
        ...
        while ((match = methodRegex.exec(content)) !== null) {
            ...
            types_1.ParserUtils.extractCallsFromBody(body, methodId, filePath, lineNum, edges);
        }
    }
}
exports.CStyleGenericParser = CStyleGenericParser;
