 ...
 */
export type NodeKind = 'file' | 'function' | 'method' | 'class' | 'interface' | 'type' | 'variable' | 'route' | 'doc_section' | 'doc_document';
export type EdgeKind = 'contains' | 'imports' | 'exports' | 'calls' | 'extends' | 'implements' | 'references' | 'documents';
